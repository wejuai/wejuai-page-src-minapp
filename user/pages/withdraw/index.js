...
const app = getApp();
const { API, UTIL, withdrawStatus } = app.globalData;
...
Page({
  ...
  getList(obj) {
    ...
    if(obj.detail) {
      ...
      if(obj.detail.withdrawStatus_ac && obj.detail.withdrawStatus_ac.id) params.status = obj.detail.withdrawStatus_ac.id;
    }
    ...
    app.REQUEST(API.ordersWithdrawal, 'GET', params, false, { showLoading: true })
    .then(res => {
